...
class StringlinesDemo:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'StringlinesDemo_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Stringlines Demo')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'StringlinesDemo')
        self.toolbar.setObjectName(u'StringlinesDemo')

        #print "** INITIALIZING StringlinesDemo"
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('StringlinesDemo', message)
    ...
    def initGui(self):
        ...
        self.add_action(
            icon_path,
            text=self.tr(u'stringlins tool'),
            callback=self.run,
